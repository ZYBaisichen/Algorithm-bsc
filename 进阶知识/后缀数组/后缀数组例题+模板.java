...
public class Code02_CreateMaximumNumber {
	...
	public static int[][] getdp(int[] arr) {
		//dp[i][j]表示[i...]范围上，拿出j个数，最大数列的开头位置
	...
	public static int[] maxPick(int[] arr, int[][] dp, int pick) {
		...
		/*
		比如在arr上拿pick=3个，从dp中拿时。即从0开头拿3个
		假设dp[0][3]=2, 则将arr[2]作为第一个数。
		接下来需要在3...n范围上拿2个，假设dp[3][2]=4，则将arr[4]作为第二个数
		接下来需要在4..n范围上拿剩余的1个数，假设dp[4][1]=8, 则将arr[8]作为第3个数
		O(k)可以拿到
		*/
