...
将d怼出来，d将要来到的位置是(4-2)*2-1=3位置，空降3位置，将c怼出来；c将要来到(3-2)*2-1位置，将c填到1位置
...
5. 如果s不正好等于3^(k-1)，可以使用凑数的方式来搞。在此之前需要先了解一个算法原型：arr=[l1,l2,l3,r1,r2]，将数组arr调整成[r1,r2,l1,l2,l3]。
流程是将l1,l2,l3逆序，r1,r2逆序，然后让整体逆序：[l3,l2,l1,r2,r1]->[r1,r2,l1,l2,l3]

6. 假设s=14, 数组为arr=[l1,l2,l3,l4,l5,l6,l7,r1,r2,r3,r4,r5,r6,r7]。
 a. 取最接近14的3^k-1为8，则在右边取8/2=4个数和左边的l1...l4放在一起做下标循环怼。将[l5,l6,l7,r1,r2,r3,r4]做完美整逆序。arr变成[l1,l2,l3,l4,r1,r2,r3,r4,l5,l6,l7,r5,r6,r7]
 b. 左边做下标循环怼，开始位置分别是l1,l3。右边s=6，再取3^k-1=2, 做逆序之后变成[l1,l2,l3,l4,r1,r2,r3,r4, l5,l6,r5,r6,l7,r7]
...
public:
   ...
   void shuffle(vector<int>& arr, int l, int r) {
        while (r-l+1>0) {//只要[l...r]上还剩余数字及一直处理
            int len = r-l+1;
            int base = 3;
            int k=1;
